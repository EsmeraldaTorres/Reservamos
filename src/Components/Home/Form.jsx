...
const Form = ({handleCityName,cityName, handleSearchCity})=>{
    ...
    return (
        <div>
          <div className="container-search text-center items-center p-10 box-border md:text-xl lg:text-2xl">
            ...
            <input type="text" 
              className="flex-grow p-1 border-indigo-300 rounded md:border-b md:border-t md:border-l  md:rounded-l-2xl" 
